...
export function Sidebar() {
  ...
  return (
    <aside
      className="fixed top-0 bottom-0 left-0 z-[100] flex w-[var(--sidebar-width)] flex-col overflow-y-auto border-r border-border bg-surface"
      role="navigation"
      aria-label="Main navigation"
    >
      <Link
        to="/dashboard"
        className="flex shrink-0 items-center gap-2 border-b border-border px-5 py-4 text-inherit no-underline"
      >
      ...
      <div className="mt-auto border-t border-border px-[18px] py-3">
        <UserMenu />
      </div>
    </aside>
  )
