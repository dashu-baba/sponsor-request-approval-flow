...
public sealed class ListManagerQueueQueryHandler(AppDbContext dbContext)
    : IRequestHandler<ListManagerQueueQuery, PagedResult<RequestListItemDto>>
{
    public async Task<PagedResult<RequestListItemDto>> Handle(
        ListManagerQueueQuery query,
